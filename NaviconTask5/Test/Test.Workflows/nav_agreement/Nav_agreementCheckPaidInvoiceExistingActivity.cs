...
{
    public class Nav_agreementCheckPaidInvoiceExistingActivity: CodeActivity
    {
        [Input("Nav_agreement")]
        [RequiredArgument]
        ...
        [Output("Is exist paid invoice connected with current agreement")]
        public OutArgument<bool> IsPaidInvoiceExist { get; set; }
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            try
            {
                ...
                IsPaidInvoiceExist.Set(context, nav_agreementService.IsPaidInvoiceExisting(agreementRef));
            }
            catch (Exception ex)
            {
